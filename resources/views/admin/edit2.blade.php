...
<body>
  ...
  <div class="container">
    ...
    <div class="tambah">
      <div class="form">
          <h2>Edit Buku</h2>
          <form action="{{ route('buku.update2', $data2->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
              <p>Url Gambar</p>
              <input type="file"  name="image" id="image" >
                <br>
              <p>Judul Buku</p>
              <input type="text"  name="judul" id="judul" value="{{ $data2->judul }}">
              <br>
              <p>Tahun Terbit</p>
              <input type="text"  name="tanggal" id="tanggal" value="{{ $data2->tanggal }}">
              <br>
              <p>Deskripsi</p>
              <input type="text"  name="deskripsi" id="deskripsi" class="deskripsi" value="{{ $data2->deskripsi }}" >
